...
public class Projectile : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        Invoke("DestroySelf", 5f); //-Al pasar 5 segundos se auto-desactiva
    }
    ...
    private void OnTriggerEnter(Collider other) //-Al colisionar contra el jugador se destuye
    {
    ...
    public void Explosion() //-Desactiva el proyectil luego de la colisión
    {
        Instantiate(explosion, transform.position, transform.rotation);
        gameObject.SetActive(false);
    }

    void DestroySelf() //-Desactiva el proyectil
    {
        gameObject.SetActive(false);
    }
}
